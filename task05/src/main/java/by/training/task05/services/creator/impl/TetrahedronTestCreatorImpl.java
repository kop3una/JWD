...
public class TetrahedronTestCreatorImpl implements TetrahedronCreator {
    private final Logger logger = LogManager.getLogger(TetrahedronTestCreatorImpl.class);
