...
import by.training.task03.services.array.HashingSort;
...
public class HashingSortIncrease implements Command {

    @Override
    public Entity execute(String... arguments) throws ControllerException { //TODO writeFilename
        ArrayCreator arrayCreator = new ArrayCreatorImpl(); // TODO factory of Services give us impl
