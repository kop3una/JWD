...
import by.training.task03.services.array.SimpleChoiceSort;
...
public class SimpleChoiceDecrease implements Command {
    @Override
    public Entity execute(String... arguments) throws ControllerException {
        ...
        try {
            ...
            Sorting simpleChoiceSort = new SimpleChoiceSort();
